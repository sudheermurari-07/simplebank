...
// TransferTxParams contains the input parameters of the transfer transfer transaction
...
// TransferTx performs a money transfer from one acc to another acc
// It creates a transfer record, add account entries and update entries balance within a single databse transaction
